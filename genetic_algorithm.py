...
class GeneticAlgorithm:
    ...
    represent_fn : Callable[[list[int]], None] = field(factory=lambda x: print(x))
    ...
    # TODO: change to make the convergence criteria provided by user
    ...
    def train(self):
        while not self.check_convergence():
            ...
            self.represent_fn(self._population)
